...
import 'package:krishaksarthiuat/data/states.dart';
import 'package:krishaksarthiuat/screens/cceForm2.dart';
...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  Color borderColor = const Color(0xFF700C79);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        drawer: SafeArea(
          child: Drawer(
            child: ListView(
              ...
              children: [
                Container(
                  decoration: const BoxDecoration(color: Color(0xFF610361)),
                  child: Column(
                ...
                Container(
                  decoration: const BoxDecoration(
                      border: Border(
                          bottom: BorderSide(
                              color: Color.fromARGB(54, 0, 0, 0), width: 1.5))),
                ),
                const Padding(
        ...
        appBar: AppBar(
          title: const Text(' CCE Dashboard'),
          titleTextStyle: const TextStyle(
              ...
              letterSpacing: 2),
          centerTitle: false,
          backgroundColor: const Color(0xFF700C79),
          actions: [
            IconButton(
                onPressed: () {
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          'Crop Cutting Experiment(CCE) Form-1 Part One',
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                    ...
                    Container(
                      ...
                      child: InputDecorator(
                        decoration: const InputDecoration(
                          contentPadding: InputBorder.none,
                      ...
                      child: InputDecorator(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                              isDense: true,
                              isExpanded: true,
                              hint: const Text('Select Notified Crop Name'),
                              value: selectedDistrict,
                              items: [],
                              //  (selectedState != null
                      ...
                      child: InputDecorator(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                              ...
                              isExpanded: true,
                              hint: const Text(
                                  'Select Level 4(Tehsil/Sub-Division/Block)'),
                              value: selectedDistrict,
                              items: [],
                              //  (selectedState != null
                              //     ? districtMap[selectedState!]!.map((String district) {
                      ...
                      child: InputDecorator(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                              ...
                              isExpanded: true,
                              hint:
                                  const Text('Select Level 6(Gram Panchayat)'),
                              value: selectedDistrict,
                              items: [],
                              //  (selectedState != null
                              //     ? districtMap[selectedState!]!.map((String district) {
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                  primary: const Color(0xFF610361)),
                              onPressed: () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const CceForm2()
                                      // CCEDashBoard(),
                                      ),
                                );
                              },
